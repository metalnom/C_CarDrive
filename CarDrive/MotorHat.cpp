...
void MotorHat::ServoControl(int Servo_num) {
    int PWMpin;
    if(Servo_num == 1) {
        PWMpin = 0;
    } else if(Servo_num == 2) {
...
void MotorHat::WheelPWM(int DC_num, int PWM) {
    int DCpin;
...
void MotorHat::WheelForward(int DC_num) {
    int In1, In2, i;
...
void MotorHat::WheelBackward(int DC_num) {
    int In1, In2, i;
...
void MotorHat::WheelStop(int DC_num) {
    int In1, In2, i;
...
void MotorHat::InitMotorHat(int M_kind) {
